...
function Footer() {
  ...
  return (
    <footer className="">
      <section className="bg-peach flex flex-col justify-center items-center pl-4 pr-4 pt-4">
        <div>
          <ul className="flex gap-x-4 text-xl metro">
            <li onClick={() => handleclick("/")}>Home</li>
          </ul>
        </div>
        <div className="flex justify-center items-center gap-x-2 pt-2 pb-2">
          ...
          <a href="https://facebook.com">
            ...
            >
              ...
              ></path>
              <path d="M17,29h4v13.2c1,0.2,2,0.3,3,0.3s2-0.1,3-0.3V29h3.6c0.5,0,0.9-0.4,1-0.9l0.4-3c0-0.3-0.1-0.6-0.2-0.8	C31.6,24.1,31.3,24,31,24h-4v-3.5c0-1.1,0.9-2,2-2h2c0.6,0,1-0.4,1-1v-3.4c0-0.5-0.4-1-0.9-1c-0.1,0-1.5-0.1-3.3-0.1	c-4.4,0-6.8,2.6-6.8,7.4V24h-4c-0.6,0-1,0.4-1,1v3C16,28.6,16.4,29,17,29z"></path>
            </svg>
          </a>
        </div>
        <div>
          <p className="metro">Copyright reserved@Prithvi Srivastava</p>
        </div>
      </section>
    </footer>
  );
